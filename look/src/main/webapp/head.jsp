                ...
                <div class="headnav_show">
                    ...
                    <div class="navbar">
                        <ul>
                            ...
                            <li><a href="/look/coach/allcoach.htm">我要学车</a></li>
                            <li><a href="http://139.199.112.205:3333/TestSystem/exam?testNum=1">理论题库</a></li>
                            <li><a href="/look/topic/alltopic.htm">经验论坛</a></li>
                            <c:if test="${empty stu}">
                            <li><a href="/look/login.jsp" onclick="alert('请登陆')">个人中心</a></li>
                            </c:if>
