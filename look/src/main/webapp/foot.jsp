            ...
            <div class="foot_bg">
                ...
                <div class="foot_con">
                    ...
                    <div class="pc_login">
                        ...
                        <p class="pc_img">
                            <a href="">
                                <img id="android_img" src="/look/imgs/android1.png" onmouseover="change_img(1)" onmouseout="reset_img(1)">
                                <img id="iphone_img" src="/look/imgs/iphone1.png" onmouseover="change_img(2)" onmouseout="reset_img(2)">
                            </a>
                        </p>
                        <p class="pc_text">
