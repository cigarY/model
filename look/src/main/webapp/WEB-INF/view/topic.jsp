        ...
        <div id="bankuai">
            <li>
                <div class="moban" style="width: 300px;height: 130px;">
                    <a href="/look/topic/getgonggaotopic.htm"><img src="../imgs/notice.jpg" alt="社区公告" style=""  /></a>
                    <a href="/look/topic/getgonggaotopic.htm"><h3>&nbsp;&nbsp;&nbsp;社区公告</h3></a><p>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;话题：${gonggao}</p> 
                    <p>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;一知天下必知</p>
            ...
            <li>
                <div class="moban" style="width: 300px;height: 130px;">
                    <a href="/look/topic/getrentietopic.htm"><img src="../imgs/hot.jpg" alt="热帖榜" style=""  /></a>
                    <a href="/look/topic/getrentietopic.htm"><h3>&nbsp;&nbsp;&nbsp;热帖榜</h3></a><p>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;话题：${retie}</p> 
                    <p>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;最火最热,最佳贴</p>
            ...
            <li>
                <div class="moban" style="width: 300px;height: 130px;">
                    <a href="/look/topic/getfenxiangtopic.htm"><img src="../imgs/share.jpg" alt="分享会" style=""  /></a>
                    <a href="/look/topic/getfenxiangtopic.htm"><h3>&nbsp;&nbsp;&nbsp;分享会</h3></a><p>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;话题：${fenxiang}</p> 
                    <p>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;我分享我快乐</p>
            ...
            <li>
                <div class="moban" style="width: 300px;height: 130px;">
                    <a href="/look/topic/getwendatopic.htm"><img src="../imgs/qa.jpg" alt="问答榜" style=""  /></a>
                    <a href="/look/topic/getwendatopic.htm"><h3>&nbsp;&nbsp;&nbsp;问答榜</h3></a><p>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;话题：${wendao}</p> 
                    <p>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;有问必答,解惑驾考难题</p>
            ...
            <li>
                <div class="moban" style="width: 300px;height: 130px;">
                    <a href="/look/topic/getyuanwangtopic.htm"><img src="../imgs/wish.jpg" alt="愿望墙" style=""  /></a>
                    <a href="/look/topic/getyuanwangtopic.htm"><h3>&nbsp;&nbsp;&nbsp;愿望墙</h3></a><p>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;话题：${yuanwang}</p> 
                    <p>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;天灵灵地灵灵我的愿望最灵</p>
            ...
            <li>
                <div class="moban" style="width: 300px;height: 130px;">
                    <a href="/look/topic/getxuechetopic.htm"><img src="../imgs/fun.jpg" alt="学车趣事" style=""  /></a>
                    <a href="/look/topic/getxuechetopic.htm"><h3>&nbsp;&nbsp;&nbsp;学车趣事</h3></a><p>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;话题：${xueche}</p> 
                    <p>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;分享趣事，一起乐呵呵</p>
